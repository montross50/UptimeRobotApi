...
class MonitorResponseNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ($type !== 'Montross50\\UptimeRobotApi\\SDK\\Model\\MonitorResponse') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \Montross50\UptimeRobotApi\SDK\Model\MonitorResponse) {
            return true;
        }
        return false;
    }
